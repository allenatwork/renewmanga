 ...
 * Usage:
 *
 * int sampleInt = APref.getInstance(context).getInt(Key.SAMPLE_INT);
 * APref.getInstance(context).set(Key.SAMPLE_INT, sampleInt);
 *
 * If APref.getInstance(Context) has been called once, you can
 * simple use APref.getInstance() to save some precious line space.
 */
public class APref {
    private static final String SETTINGS_NAME = "default_settings";
    private static APref sSharedPrefs;
    ...
    private APref(Context context) {
        mPref = context.getSharedPreferences(SETTINGS_NAME, Context.MODE_PRIVATE);
    }

    public static void initPref(Context context) {
        if (sSharedPrefs == null) {
            sSharedPrefs = new APref(context.getApplicationContext());
        }
    }

    public static APref getInstance(Context context) {
        if (sSharedPrefs == null) {
            sSharedPrefs = new APref(context.getApplicationContext());
        }
        return sSharedPrefs;
