...
/**
 * Rate Me dialog. Entry point into the library. Use the {@link allen.testmg.rateme.RateMeDialog.Builder} to
...
public class RateMeDialog extends DialogFragment {
    ...
    private allen.testmg.rateme.OnRatingListener onRatingListener;
    ...
    public RateMeDialog(String appPackageName,
                        ...
                        allen.testmg.rateme.OnRatingListener onRatingListener) {
        ...
        try {
            close.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    onRatingListener.onRating(allen.testmg.rateme.OnRatingListener.RatingAction.DISMISSED_WITH_CROSS, ratingBar.getRating());
                }
            });
        } catch (Exception e) {
        ...
        try {
            ...
            share.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    onRatingListener.onRating(allen.testmg.rateme.OnRatingListener.RatingAction.SHARED_APP, ratingBar.getRating());
    ...
    private void configureButtons() {
        rateMe.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                RateMeDialogTimer.setOptOut(getActivity(), true);
                onRatingListener.onRating(allen.testmg.rateme.OnRatingListener.RatingAction.HIGH_RATING_WENT_TO_GOOGLE_PLAY, ratingBar.getRating());
                dismiss();
            }
        });
        ...
        noThanks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (feedbackByEmailEnabled) {
                    DialogFragment dialogMail = allen.testmg.rateme.FeedbackDialog.newInstance(feedbackEmail,
                            appName,
                    ...
                    dismiss();
                    onRatingListener.onRating(allen.testmg.rateme.OnRatingListener.RatingAction.LOW_RATING, ratingBar.getRating());
                }
                RateMeDialogTimer.setOptOut(getActivity(), true);
            }
        });
    ...
    public static class Builder {
        ...
        private allen.testmg.rateme.OnRatingListener onRatingListener = new allen.testmg.rateme.DefaultOnRatingListener();
        ...
        /**
         * @see allen.testmg.rateme.OnRatingListener
         */
